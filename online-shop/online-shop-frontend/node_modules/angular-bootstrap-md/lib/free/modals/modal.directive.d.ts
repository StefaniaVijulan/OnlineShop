...
export declare class ModalDirective implements AfterViewInit, OnDestroy, OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ModalDirective, "[mdbModal]", ["mdb-modal", "mdbModal"], { "config": "config"; }, { "onShow": "onShow"; "open": "open"; "onShown": "onShown"; "opened": "opened"; "onHide": "onHide"; "close": "close"; "onHidden": "onHidden"; "closed": "closed"; }, never, ["*"], false>;
}
