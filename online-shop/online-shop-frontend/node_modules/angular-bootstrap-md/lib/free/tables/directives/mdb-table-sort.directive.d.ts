...
export declare class MdbTableSortDirective implements OnInit, AfterViewInit {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<MdbTableSortDirective, "[mdbTableSort]", never, { "dataSource": "mdbTableSort"; "sortBy": "sortBy"; "sortIcon": "sortIcon"; "resetSortDirection": "resetSortDirection"; }, { "sortEnd": "sortEnd"; "sorted": "sorted"; }, never, never, false>;
}
export {};
